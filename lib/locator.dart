...
void setupLocator() {
  ...
  locator.registerFactory(
      () => RegionMenuCubit(getRegionsAndScoresModelUC: locator.get(), getCoinsUC: locator.get()));
  locator.registerFactory(() => RegionOptionCubit(getRegionOptionDetailModelUC: locator.get()));
}
